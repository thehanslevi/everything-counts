...
A place to log reading that doesn't count anywhere else: articles, blogs, chapters, papers, poems, newsletters, reports, and more. A reminder that the number of books read or on a DNC shelf don't adequately represent a reading life. A way to express yourself as a reader that goes beyond Goodreads.
